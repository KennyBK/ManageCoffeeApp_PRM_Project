...
import com.example.managecoffeeapp_prm_project.interfaces.ItemLoaiHangOnClick;
import com.example.managecoffeeapp_prm_project.model.LoaiHang;
...
public class LoaiHangAdapter extends RecyclerView.Adapter<LoaiHangAdapter.LoaiHangViewHolder> {
    ...
    public LoaiHangViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(com.example.managecoffeeapp_prm_project.R.layout.layout_item_loai_hang, parent, false);
    ...
    public static class LoaiHangViewHolder extends RecyclerView.ViewHolder {
        ...
        public LoaiHangViewHolder(@NonNull View itemView) {
            super(itemView);
            ivHinhAnh = itemView.findViewById(com.example.managecoffeeapp_prm_project.R.id.ivHinhAnh);
            tvTenLoaiHang = itemView.findViewById(com.example.managecoffeeapp_prm_project.R.id.tvTenLoaiHang);
        }
    }
}
